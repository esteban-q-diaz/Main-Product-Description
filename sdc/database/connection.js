...
//   .then(() => client.query(csvProductDetails))
...
/* ----- CHECKOUT -----*/
  ...
  const csvCheckoutImport = {
    text: "COPY checkout (activeUser, wishList, watchList, userCart)  FROM '/Users/rebrnd/Documents/Hack_Reactor/Immersive/Week_9/sdc/Main-Product-Description/sdc/data_generator/checkout.csv' DELIMITER ',' CSV HEADER",
    values: []
   }
...
async function execute() {
  try {
    ...
    const results = await client.query('select * from checkout')
